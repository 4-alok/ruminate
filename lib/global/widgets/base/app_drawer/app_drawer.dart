...
class AppDrawer extends StatelessWidget {
  ...
  bool get isAppDrawerOpen => locator<AppService>().isAppDrawerOpen;
  ...
  Widget createPlaylist(BuildContext context) => isAppDrawerOpen
      ? InkWell(
          onTap: () {},
          child: SizedBox(
              height: 48,
  ...
  Widget appDrawerPlaylist(BuildContext context) => isAppDrawerOpen
